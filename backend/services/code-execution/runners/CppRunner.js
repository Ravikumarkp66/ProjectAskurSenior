...
/**
 * C++ Language Execution Runner (G++ 14 / C++17)
 * 
    ...
    async execute({ code, input = '' }) {
        ...
        return new Promise((resolve) => {
            ...
            child.on('close', (exitCode, signal) => {
                ...
                if (actualCode !== 0) {
                    const isGppError = stderrData.includes('error:') || 
                                       stderrData.includes('/app/main.cpp:') || 
                                       stderrData.includes('g++:') ||
                                       stderrData.includes('undefined reference') ||
                                       stderrData.includes('ld returned');

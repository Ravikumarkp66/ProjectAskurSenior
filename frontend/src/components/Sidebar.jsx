                ...
                <nav className="flex-1 p-4 space-y-2 overflow-y-auto custom-scrollbar">
                    ...
                    <div className="space-y-1">
                        ...
                        <button
                            ...
                            className={`${isCollapsed ? 'justify-center' : ''} w-full flex items-center gap-3 p-3 rounded-xl transition ${sidebarClasses.panel} ${sidebarClasses.panelHover} border-2 border-indigo-500/20`}
                            title="Academic Setup"
                        >
                            <svg className="w-5 h-5 text-indigo-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                            </svg>
                            {!isCollapsed && <span className="text-sm font-semibold text-indigo-600 dark:text-indigo-400">Academic Setup</span>}
                        </button>
                                ...
                                */}
                                ...
                                >
                                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 512 512">
                                        <path d="M444.17 32L32.81 32c-18.04 0-32.81 14.77-32.81 32.81l0 311.66c0 18.04 14.77 32.81 32.81 32.81h378.55l-14.77-50.85 34.45 31.98 31.98 29.53 52.49 46.75l0-401.88c0-18.04-14.77-32.81-32.81-32.81zM304.14 290.31l-14.77-18.45c25.84-7.38 41.81-22.14 41.81-22.14-13.53 8.61-24.61 12.3-34.45 14.77-14.77 4.92-28.31 4.92-38.15 4.92h-1.23c-14.77 0-32.31-2.46-51.69-8.61-9.85-2.46-22.14-7.38-35.68-14.77 0 0 15.13 13.53 38.58 20.91l-11.83 14.1 c-41.81-1.23-56.57-27.06-56.57-27.06 0-56.57 25.84-102.13 25.84-102.13 25.84-19.68 50.43-18.45 50.43-18.45l2.46 2.46c-31.11 8.61-45.52 22.14-45.52 22.14 0 0 3.69-2.46 11.07-4.92 19.68-8.61 35.68-11.07 41.81-11.07 1.23 0 2.46 0 4.92 0.3c15.93 1.23 31.62 4.09 46.12 11.07 0 0-14.41-11.07-40.58-18.45l3.69-3.69c0 0 24.61-1.23 50.43 18.45 0 0 25.84 45.56 25.84 102.13 0 1.23-14.77 28.29-57.81 29.53zM196.26 182.25c-15.13 0-27.06 13.53-27.06 29.53s11.94 29.53 27.06 29.53c15.13 0 27.06-13.53 27.06-29.53s-12.3-29.53-27.06-29.53zM286.42 182.25c-15.13 0-27.06 13.53-27.06 29.53s11.94 29.53 27.06 29.53c15.13 0 27.06-13.53 27.06-29.53s-11.94-29.53-27.06-29.53z" />
                                    </svg>

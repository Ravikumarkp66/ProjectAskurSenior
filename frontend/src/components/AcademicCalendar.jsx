      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className={`p-1.5 rounded-lg border text-[10px] font-black uppercase tracking-widest transition-all ${
              isLightMode ? 'bg-gray-50 border-gray-200 text-gray-500' : 'bg-white/5 border-white/10 text-gray-400'
            }`}
          >
            ...
            {days.map((day, idx) => {
              ...
              return (
                <div 
                  ...
                  className={`relative min-h-[60px] sm:min-h-[80px] p-2 rounded-2xl border cursor-pointer transition-all ${

/* ═══════════════════════════════════════════════════════════════════
   ...
   Confirmation dialog for deleting a query (Owner / Admin)
═══════════════════════════════════════════════════════════════════ */

import React from 'react';
import { AlertTriangle, X, Trash2 } from 'lucide-react';

const DeleteConfirmModal = ({ isOpen, onClose, item, onConfirmDelete }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 overflow-y-auto">
            ...
            <div className="relative w-full max-w-sm bg-[#161B22] border border-[#21262D] rounded-2xl shadow-2xl overflow-hidden z-10 my-auto p-5 text-center">
                ...
                <h3 className="text-base font-bold text-[#E6EDF3]">Delete Query?</h3>
                <p className="text-xs text-[#8B949E] mt-1.5 leading-relaxed">
                    Are you sure you want to remove <span className="font-semibold text-[#E6EDF3]">"{item.title}"</span>? This action cannot be undone.
                </p>

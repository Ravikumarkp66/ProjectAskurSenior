    ...
    return (
        ...
        >
            ...
            <div className="mt-5">
                ...
                <p className="mt-2 text-sm text-white/70">Sign in to continue tracking your academic progress.</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="mt-6 space-y-4">
                ...
                {!isLogin && (
                    <div>
                        <label className="block text-sm font-semibold text-white/80 mb-2">College Email</label>
                        <input
                            type="email"
                            name="email"
                ...
                <div>
                    ...
                    <input
                        ...
                        className="w-full min-h-11 rounded-2xl px-4 bg-white/10 border border-white/15 text-white placeholder-white/40 outline-none transition focus:border-white/30 focus:ring-2 focus:ring-white/20"
                    />
                    {!isLogin && <p className="text-xs text-white/55 mt-1">Minimum 6 characters</p>}
                ...
                <button
                    type="submit"
                    disabled={loading}
                    className="w-full min-h-11 rounded-full px-4 text-sm font-bold text-white shadow-lg transition disabled:opacity-60 disabled:cursor-not-allowed bg-gradient-to-r from-sky-500 to-purple-600 hover:from-sky-400 hover:to-purple-500"
                >
